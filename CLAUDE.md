...
This project is indexed by GitNexus as **teamagentx** (9691 symbols, 17285 relationships, 270 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

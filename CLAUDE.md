...
This project is indexed by GitNexus as **teamagentx** (9662 symbols, 17152 relationships, 271 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

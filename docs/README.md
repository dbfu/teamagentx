...
| [14-agent-dispatch-flowcharts.md](14-agent-dispatch-flowcharts.md) | **调度系统全场景流程图**（Mermaid）· 当前实现权威说明 · 并行/串行/兜底 | ⭐⭐⭐⭐ | 约 5k |
...
- ⭐ **智能协作模式**（合并 auto/coordinator）：快路径接力 + 协调器 5 点兜底 + 协作预算两重熔断 + 并行/串行派发（2026-06）

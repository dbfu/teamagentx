            ...
            <div className="w-[360px] rounded-2xl bg-card shadow-xl p-6">
              <div className="flex items-center justify-center mb-4">
                <div className="rounded-full bg-orange-100 p-3">
                  <VolumeX className="size-6 text-orange-600" />
                </div>
              </div>
              <h3 className="text-lg font-semibold text-foreground text-center mb-3">安全提示</h3>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 rounded-lg border border-gray-200 text-gray-600 px-4 py-2.5 text-sm hover:bg-gray-50"
                >
                  取消
                </button>
                <button
                  ...
                  className="flex-1 rounded-lg bg-blue-500 px-4 py-2.5 text-sm text-white hover:bg-blue-600"
                >
                  我已了解，生成二维码
                </button>
              </div>

// Generated by scripts/sync-material-file-icons.mjs. Do not edit manually.

export const materialFileIconSource = {"name":"Material Icon Theme","version":"5.37.0","theme":"light"} as const;

export const defaultMaterialFileIcon = "file";

export const materialFileNames: Readonly<Record<string, string>> = {
  ".pug-lintrc": "pug",
  ".pug-lintrc.js": "pug",
  ".pug-lintrc.json": "pug",
  "justfile": "just",
...
export const materialFileExtensions: Readonly<Record<string, string>> = {
  "60": "slint",
  "htm": "html",
  "xhtml": "html",
  "html_vm": "html",

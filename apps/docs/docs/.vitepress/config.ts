    ...
    sidebar: [
      {
        text: '详细用户手册',
        items: [
          { text: '总览与上手路径', link: '/guide/overview' },
          { text: '模型配置', link: '/guide/model-config' },
          { text: '技能配置', link: '/guide/skill-config' },
          { text: '助手配置', link: '/guide/assistant-config' },
          { text: '群聊、模板与调度', link: '/guide/chatroom' },
        ],
      },
      {
        text: '用户手册',

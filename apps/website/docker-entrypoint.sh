...
WEBSITE_SERVER_PROXY_TARGET="${WEBSITE_SERVER_PROXY_TARGET:-http://website-server:3207}"
...
export WEBSITE_SERVER_PROXY_TARGET
envsubst '${WEBSITE_SERVER_PROXY_TARGET}' < "$NGINX_TEMPLATE" > "$NGINX_OUTPUT"
echo "[entrypoint] nginx resolver upstream: ${WEBSITE_SERVER_PROXY_TARGET}"

...
This project is indexed by GitNexus as **teamagentx** (12209 symbols, 19428 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

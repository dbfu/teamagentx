...
This project is indexed by GitNexus as **teamagentx** (16924 symbols, 27680 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **teamagentx** (18327 symbols, 29358 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

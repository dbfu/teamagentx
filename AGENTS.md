...
This project is indexed by GitNexus as **teamagentx** (11919 symbols, 19670 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

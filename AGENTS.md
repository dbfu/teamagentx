...
This project is indexed by GitNexus as **teamagentx** (17602 symbols, 28717 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

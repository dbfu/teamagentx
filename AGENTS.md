...
This project is indexed by GitNexus as **teamagentx** (7824 symbols, 14491 relationships, 255 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

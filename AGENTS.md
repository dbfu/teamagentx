...
This project is indexed by GitNexus as **teamagentx** (18211 symbols, 29203 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

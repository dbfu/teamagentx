...
This project is indexed by GitNexus as **teamagentx** (12183 symbols, 20141 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

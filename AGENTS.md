...
This project is indexed by GitNexus as **teamagentx** (18055 symbols, 28981 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
